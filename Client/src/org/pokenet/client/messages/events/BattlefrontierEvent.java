...
import org.pokenet.client.ui.frames.BattlefrontierDialog;
...
//			System.out.println("battle tower lvl 50");
		...
		if (!battle.equals("no_battle"))
			...
			GameClient.getInstance().getDisplay().add(new BattlefrontierDialog(battle,GameClient.getInstance().getOurPlayer()));
	}
}
