...
public class ConfirmationDialog extends ResizableFrame
{
	...
	{
		int height = (int) GameClient.getInstance().getDisplay().getHeight(); // TODO: Chappie, y u fail and use the SUI Display class :S
		int width = (int) GameClient.getInstance().getDisplay().getWidth(); // TODO: Chappie, y u fail and use the SUI Display class :S
