...
public class ComboBox extends Container
{
	...
	public ComboBox()
	{
		...
		m_arrow = new SimpleArrowButton(Button.DOWN);
		m_arrow.addActionListener(new ActionListener()
		{
			...
			public void actionPerformed(ActionEvent e)
			{
				...
				{
					m_itemSelector = new ItemSelector(m_this, 6, m_elements.toArray(new String[m_elements.size()]), (int) getWidth(), (int) m_arrow.getWidth());
	...
	public void setSelected(String item)
	{
		...
		m_item.addMouseListener(new MouseAdapter()
		{
			...
			public void mousePressed(MouseEvent e)
			{
				if(m_itemSelector == null)
				{
					m_itemSelector = new ItemSelector(m_this, 5, m_elements.toArray(new String[m_elements.size()]), (int) getWidth(), (int) m_arrow.getWidth());
					m_itemSelector.setLocation(getAbsoluteX(), getAbsoluteY() - 5);
					getDisplay().add(m_itemSelector);
				}
				else
...
class ItemSelector extends Frame
{
	 ...
	 */
	@SuppressWarnings("deprecation")
	public ItemSelector(ComboBox parent, int shown, String[] items, int width, int buttonWidth)
	{
		m_parent = parent;
		m_amountShown = shown;
		m_items = items;
