...
public class ShopDialog extends Frame
{
	...
	public void buyGUI()
	{
		...
		try
		{
			...
			m_categoryButtons[0].setImage(new Image(FileLoader.loadFile(respath + "res/ui/shop/pokeball.png"), respath + "res/ui/shop/pokeball.png", false));
		}
		catch(Exception e)
		{
			e.printStackTrace();
		...
		try
		{
			m_categoryButtons[1].setImage(new Image(FileLoader.loadFile(respath + "res/ui/shop/potion.png"), respath + "res/ui/shop/potion.png", false));
		}
		catch(Exception e)
		{
			e.printStackTrace();
		...
		try
		{
			m_categoryButtons[2].setImage(new Image(FileLoader.loadFile(respath + "res/ui/shop/status.png"), respath + "res/ui/shop/status.png", false));
		}
		catch(Exception e)
		{
			e.printStackTrace();
		...
		try
		{
			m_categoryButtons[3].setImage(new Image(FileLoader.loadFile(respath + "res/ui/shop/field.png"), respath + "res/ui/shop/field.png", false));
		}
		catch(Exception e)
		{
			e.printStackTrace();
	...
	private void initItems()
	{
		...
		for(int i = 0; i < m_items.size(); i++)
		{
			...
			try
			{
				...
				{
					m_itemPics[i] = new Label(new Image(FileLoader.loadFile(respath + "res/items/24/TM.png"), respath + "res/items/24/TM.png",
							false));
				}
				else
				{
					m_itemPics[i] = new Label(new Image(FileLoader.loadFile(respath + "res/items/24/" + m_items.get(i).getId() + ".png"), respath + "res/items/24/" + m_items.get(i).getId() + ".png",
							false));
				}
				LoadingList.setDeferredLoading(false);
			...
			try
			{
				...
				if(m_stock.get(m_items.get(i).getId()) >= 100)
					...
					stock = "halfempty";
				m_itemStockPics[i] = new Label(new Image(FileLoader.loadFile(respath + "res/ui/shop/" + stock + ".png"), respath + "res/ui/shop/" + stock + ".png", false));
				LoadingList.setDeferredLoading(false);
