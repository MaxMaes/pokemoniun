...
public class GameClient extends BasicGame
{
	...
	public void update(GameContainer gc, int delta) throws SlickException
	{
		...
		if(m_started)
		{
			...
			{
				if(m_ourPlayer != null && !m_isNewMap && !BattleManager.isBattling() && m_ourPlayer.canMove())
				{
	...
	/*
	 * @Override public void controllerDownPressed(int controller){ if(m_ui.getNPCSpeech() == null && m_ui.getChat().isActive()==false && !m_login.isVisible() && !m_ui.getChat().isActive() && !getDisplay().containsChild(m_playerDialog)){ if(m_ourPlayer != null && !m_isNewMap /*&& m_loading != null && !m_loading.isVisible() && m_ourPlayer.canMove()) { if(!m_mapMatrix.getCurrentMap().isColliding(m_ourPlayer, Direction.Down)) { this.move(Direction.Down); } else if(m_ourPlayer.getDirection() != Direction.Down) { this.move(Direction.Down); } } } } */

	/*
	 * @Override public void controllerUpPressed(int controller){ if(m_ui.getNPCSpeech() == null && m_ui.getChat().isActive()==false && !m_login.isVisible() && !m_ui.getChat().isActive() && !getDisplay().containsChild(m_playerDialog)){ if(m_ourPlayer != null && !m_isNewMap /*&& m_loading != null && !m_loading.isVisible() && m_ourPlayer.canMove()) { if(!m_mapMatrix.getCurrentMap().isColliding(m_ourPlayer, Direction.Up)) { this.move(Direction.Up); } else if(m_ourPlayer.getDirection() != Direction.Up) { this.move(Direction.Up); } } } } */

	/*
	 * @Override public void controllerLeftPressed(int controller){ if(m_ui.getNPCSpeech() == null && m_ui.getChat().isActive() == false && !m_login.isVisible() && !m_ui.getChat().isActive() && !getDisplay().containsChild(m_playerDialog)){ if(m_ourPlayer != null && !m_isNewMap /*&& m_loading != null && !m_loading.isVisible() && m_ourPlayer.canMove()) { if(!m_mapMatrix.getCurrentMap().isColliding(m_ourPlayer, Direction.Left)) { this.move(Direction.Left); } else if(m_ourPlayer.getDirection() != Direction.Left) { this.move(Direction.Left); } } } } */

	/*
	 * @Override public void controllerRightPressed(int controller){ if(m_ui.getNPCSpeech() == null && m_ui.getChat().isActive()==false && !m_login.isVisible() && !m_ui.getChat().isActive() && !getDisplay().containsChild(m_playerDialog)){ if(m_ourPlayer != null && !m_isNewMap /*&& m_loading != null && !m_loading.isVisible() && m_ourPlayer.canMove()) { if(!m_mapMatrix.getCurrentMap().isColliding(m_ourPlayer, Direction.Right)) { this.move(Direction.Right); } else if(m_ourPlayer.getDirection() != Direction.Right) { this.move(Direction.Right); } } } } */
	...
	public static void main(String[] args)
	{
		...
		try
		{
			gc = new AppGameContainer(new GameClient("Pokénet: Squishy Squirtle"), 800, 600, fullscreen);
