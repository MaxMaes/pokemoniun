...
public class ConnectionHandler extends SimpleChannelHandler {
	...
	public void channelOpen(ChannelHandlerContext ctnx, ChannelStateEvent e) {
		...
		GameClient.session = new Session(ctnx.getChannel());
		
		/*if (!ActiveConnections.addSession(ctnx.getChannel())) {
	...
	public void messageReceived(ChannelHandlerContext ctx, MessageEvent e) {
		...
		try
		{
			...
			if (GameClient.session != null) {
				GameClient.session.parseMessage(msg);
			}
			else {
