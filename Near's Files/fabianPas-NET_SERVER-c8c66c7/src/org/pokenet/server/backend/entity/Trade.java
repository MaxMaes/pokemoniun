		...
		if(player1 instanceof PlayerChar) {
			...
			for(int i = 0; i < player2Party.length; i++) {
				if(player2Party[i] != null) {
					...
					addPoke.Init(6);
					addPoke.addInt(i);
					addPoke.addString(PokemonSpecies.getDefaultData().getPokemonByName(player2Party[i].getSpeciesName()).getSpeciesNumber() + "," +
		...
		if(player2 instanceof PlayerChar) {
			...
			for(int i = 0; i < player1Party.length; i++) {
				if(player1Party[i] != null) {
					...
					addPoke.Init(6);
					addPoke.addInt(i);
					addPoke.addString(PokemonSpecies.getDefaultData().getPokemonByName(player1Party[i].getSpeciesName()).getSpeciesNumber() + "," +
