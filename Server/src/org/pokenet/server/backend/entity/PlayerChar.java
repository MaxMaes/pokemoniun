...
public class PlayerChar extends Char implements Battleable, Tradeable
{
	 ...
	 * 
	 * @return ip If there is a TCP session the IP address, otherwise and empty string.
	 */
	...
	/**
	 * Sets how many steps this playter can repel Pokemon for.
	 * 
	 * @param steps Number of steps to repel.
	 */
	 ...
	 * 
	 * @return m_repel The number of steps.
	 */
	public int getRepel()
	{
		return m_repel;
	...
	/**
	 * Releases a pokemon from a box.
	 * 
	 * @param box The box number.
	 * @param slot The slot number of the box.
	 */
	...
	/**
	 * Swaps pokemon between box and party. Fails if we have only 1 pokemon or no more boxes left.
	 * 
	 * @param box The box number
	 * @param boxSlot The box slot number.
	 * @param partySlot The slot number in the party.
	 */
	 ...
	 * 
	 * @return m_isSpriting Returns true if the player is interacting with a sprite selection NPC, otherwise false.
	 */
	...
	/**
	 * Returns the preferred language of the player.
	 * 
	 * @return m_language The language of the player.
	 */
	...
	/**
	 * Returns if the player is trading.
	 * 
	 * @return m_trade True if the player is trading, otherwise false.
	 */
	...
	/** Cancels this player's trade. */
	public void cancelTrade()
	{
		m_trade.endTrade();
	}

	/** Wraps up a trading session. */
	...
	/**
	 * Returns the trade that the player may be involved in.
	 * 
	 * @return m_trade Trade a player may be involved in.
	 */
	...
	/**
	 * Sets the trade this player is going to be involved in.
	 * 
	 * @param t The trade to set.
	 */
	 ...
	 * 
	 * @return m_isReadyToTrade True if the player accepted a trade offer, otherwise false.
	 */
	 ...
	 * 
	 * @return True if the player meets the conditions to trade, otherwise false.
	 */
	 ...
	 */
	public void addRequest(String username, RequestType reqtype)
	{
		/* Check if it is a battle request on a pvp enforced map */
		if(reqtype == RequestType.BATTLE)
		{
		...
		m_requests.put(username, reqtype);
	}

	/**
	 * Removes a request.
	 * 
	 * @param username The username of the player to remove the request from.
	 */
	 ...
	 * 
	 * @param username The username of the player that accepted the request.
	 */
	...
	/**
	 * Returns the shop the player is currently interacting with.
	 * 
	 * @return m_currentShop The shop the player is currently interacting with.
	 */
	public Shop getShop()
	{
	 ...
	 * 
	 * @return m_isBoxing True if the player is accesing his/her box, otherwise false.
	 */
	 ...
	 * 
	 * @param b If the player is boxing.
	 */
	 ...
	 * 
	 * @return m_isMuted True if the player is muted, otherwise false.
	 */
	 ...
	 * 
	 * @param b If the player is muted.
	 */
	 ...
	 * 
	 * @param a Index of the first poke.
	 * @param b Index of the second pokemon.mon
	 */
	 ...
	 * 
	 * @return m_isTalking True if the player is talking to an NPC, otherwise false.
	 */
	 ...
	 * 
	 * @param b If the player is talking to an NPC.
	 */
	 ...
	 * 
	 * @return The number of the highest leveled pokemon in the party.
	 */
	 ...
	 * 
	 * @param b Is the player battling.
	 */
	 ...
	 * 
	 * @param session The TCP connection to the server.
	 */
	 ...
	 * 
	 * @return m_tcpSession The TCP connection to the server.
	 */
	 ...
	 * 
	 * @return m_udpSession The UDP connection to the server.
	 */
	 ...
	 * 
	 * @param money The number of Pokeyen.
	 */
	 ...
	 * 
	 * @return m_money The number of Pokeyen.
	 */
	public int getMoney()
	{
		return m_money;
	 ...
	 * 
	 * @return m_isFishing True if the player is currently fishing, otherwise false.
	 */
	 ...
	 * 
	 * @param b If this player is fishing.
	 */
	 ...
	 * 
	 * @param exp The number of experience.
	 */
	 ...
	 * 
	 * @return m_skillHerbExp The number of herbalism experience.
	 */
	 ...
	 * 
	 * @return level The level number of the herbalism skill.
	 */
	 ...
	 * 
	 * @param exp The crafting experience.
	 */
	 ...
	 * 
	 * @param exp The number of crafting experience to add.
	 */
	 ...
	 * 
	 * @return m_skillCraftExp The number of crafting experience.
	 */
	 ...
	 * 
	 * @return level The level of the crafting skill.
	 */
	 ...
	 * 
	 * @param exp The number of fishing experience to add.
	 */
	 ...
	 * 
	 * @return m_skillFishExp The fishing skill experience.
	 */
	 ...
	 * 
	 * @return level The level of the fishing skill.
	 */
	 ...
	 * 
	 * @param exp The number of experience to add.
	 */
	 ...
	 * 
	 * @return m_skillTrainingExp The number of experience.
	 */
	 ...
	 * 
	 * @return level The level of the training skill.
	 */
	 ...
	 * 
	 * @return m_skillCoordExp The number of experience.
	 */
	 ...
	 * 
	 * @return level The coordinating skill level.
	 */
	 ...
	 * 
	 * @return m_skillBreedExp The number of experience.
	 */
	 ...
	 * 
	 * @return level The breeding skill level.
	 */
	 ...
	 * 
	 * @return m_boxes The boxes of this player.
	 */
	 ...
	 * 
	 * @param p The caught Pokemon to store.
	 */
	 ...
	 * 
	 * @param p The pokemon to add to the party or box.
	 */
	 ...
	 * 
	 * @param t The last time of login.
	 */
	 ...
	 * 
	 * @return m_lastLogin The last login time.
	 */
	...
	public void setMap(ServerMap map, Direction dir)
	{
		...
		for(int i = 0; i < map.getNpcs().size(); i++)
		{
			...
			if(!c.getName().equalsIgnoreCase("NULL"))
			{
				...
				packet = packet + "!NPC!," + c.getId() + "," + c.getSprite() + "," + c.getX() + "," + c.getY() + "," + (c.getFacing() == Direction.Down ? "D" : c.getFacing() == Direction.Up ? "U" : c.getFacing() == Direction.Left ? "L" : "R") + ",";
			}
		}
	 ...
	 * 
	 * @param b Is the player shopping.
	 */
	 ...
	 * 
	 * @return m_isShopping True is the player is shopping, otherwise false.
	 */
	 ...
	 * 
	 * @param badge The number of the badge.
	 * @return True if the player has this badge, otherwise false.
	 */
	 ...
	 * 
	 * @param badges The badges this player has
	 */
	 ...
	 * 
	 * @param num The number of the badge to add.
	 */
	 ...
	 * 
	 * @param badges The string of badges.
	 */
	 ...
	 * 
	 * @return m_badges The badges of the player.
	 */
	 ...
	 * 
	 * @return m_adminLevel The admin level of this player.
	 */
	 ...
	 * 
	 * @return m_healX The x-coordinate of the point the player was last healed.
	 */
	public int getHealX()
	{
		return m_healX;
	 ...
	 * 
	 * @return m_healY The y-coordinate of the point the player was last healed.
	 */
	public int getHealY()
	{
		return m_healY;
	 ...
	 * 
	 * @return m_healMapx The x-coordinate of the point of the map the player was last healed.
	 */
	 ...
	 * 
	 * @return m_healMapY The y-coordinate of the point of the map the player was last healed.
	 */
	...
	/**
	 * Returns if this player can surf.
	 * 
	 * @return boolean True if this player can surf, otherwise false.
	 */
	 ...
	 * 
	 * @return The number of badges this player has.
	 */
	 ...
	 * 
	 * @param index The index of the pokemon in the party of the player.
	 */
	 ...
	 * 
	 * @param i The index of the pokemon in the party of the player.
	 */
	public void updateClientPokemonStats(int i)
	{
		if(m_pokemon[i] != null)
		{
			m_tcpSession.write("PS" + i + m_pokemon[i].getHealth() + "," + m_pokemon[i].getStat(0) + "," + m_pokemon[i].getStat(1) + "," + m_pokemon[i].getStat(2) + "," + m_pokemon[i].getStat(3) + "," + m_pokemon[i].getStat(4) + "," + m_pokemon[i].getStat(5));
	 ...
	 * 
	 * @param index The index of the item in the bag of the player.
	 */
