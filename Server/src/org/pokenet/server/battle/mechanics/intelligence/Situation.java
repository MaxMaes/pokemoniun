...
public class Situation
{
	...
	private Situation()
	{
		...
		if(f.exists())
			...
			m_memory.add(new Memory(PokemonType.T_BUG, PokemonType.T_DARK, true, "Tackle"));
	}
	...
	public synchronized String getBestMemory(final Memory target, String[] moves)
	{
		...
		// TODO: check if no errors occur after adding <Memory>.
		...
		{
			Memory best = m_memory.get(m_random.nextInt(m_memory.size()));
