...
public class TcpProtocolHandler extends IoHandlerAdapter
{
	...
	{
		/* TODO:Receive String instead of Object? */
		int packet = 0;
		String[] details;
		...
		else
		{
			...
			switch(message.charAt(0))
			{
				...
				case 's':
					// Party swapping
					p.swapPokemon(Integer.parseInt(message.substring(1, message.indexOf(','))), Integer.parseInt(message.substring(message.indexOf(',') + 1)));
					break;
				case 'S':
					// Shop interaction
					if(p.isShopping())
