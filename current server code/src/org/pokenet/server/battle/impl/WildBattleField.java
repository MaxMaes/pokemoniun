...
public class WildBattleField extends BattleField {
	...
	private String[] spatt = {"bulbasaur,1","ivysaur,1","venusaur,2","charmeleon,1","charizard,3","butterfree,2","oddish,1","gloom,2","vileplume,3","venomoth,1","psyduck,1","golduck,2","abra,1","kadabra,2","alakazam,3","megnemite,1","magneton,2","gastly,1","haunter,2","gengar,3","exeggutor,2","horsea,1","seadra,2","jynx,2","magmar,2","porygon,1","zapdos,3","moltres,3","mewtwo,3","quilava,1","typhlosion,3","natu,1","xatu,1","mareep,1","flaaffy,2","ampharos,3","sunkern1","sunflora,2","espeon,2","unown,1","girafarig,2","slugma,1","remoraid,1","octillery,1","houndour,1","houndoom,2","kingdra,1","porygon2,2","smoochum,1","raikou,1","torchic,1","combusken,1","beautifly,3","ralts,1","kirlia,2","gardevoir,3","masquerain,1","roselia,2","numel,1","camerupt,1","spinda,1","cacnea,1","cacturne,1","seviper,1","lunatone,2","chimecho,1","gorebyss,2","latios,3","kyogre,3","rayquaza,1","deoxys,1","monferno,1","infernape,1","piplup,1","prinplup,2","empoleon,3","budew,1","roserade,3","mothim,1","cherubi,1","cherrim,2","mismagius,1","chingling,1","lucario,1","abomasnow,1","magnezone,3","magmortar,3","togekiss,2","glaceon,2","porygon-z,3","rotom,1","mesprit,1","azelf,1","dialga,3","palkia,3","heatran,3","darkrai,2"};
	private String[] spdef = {"ivysaur,1","venusaur,1","wartortle,1","blastoise,3","butterfree,1","beedrill,1","ninetales,1","venonat,1","tentacool,1","tentacruel,2","seel,1","dewgong,2","drowzee,1","hypno,2","hitmonchan,2","mr.mime,2","eevee,1","articuno,3","chikorita,1","bayleef,1","meganium,2","ledyba,1","ledian,2","cleffa,1","togepi,1","togetic,2","bellossom,3","politoed,3","hoppip,1","umbreon,2","slowking,3","midreavus,1","shuckle,1","corsola,1","mantine,2","kingdra,1","hitmontop,2","suicune,2","lugia,3","ho-oh,3","dustox,3","lotad,1","lombre,2","ludicolo,3","masquerain,1","spoink,1","grumpig,2","swablu,1","altaria,2","baltoy,1","claydol,2","lileep,1","cradily,2","milotic,2","kecleon,1","duskull,1","duclops,1","chimecho,1","regice,3","registeel,1","latias,3","burmy,1","wormadam,2","vespiquen,1","mismagius,1","bronzong,1","mime jr.,1","spiritomb,1","mantyke,1","togekiss,1","probopass,2","dusknoir,2","uxie,1","mesprit,1","cresselia,3"};
	private String[] speed = {"charmander,1","charmeleon,1","WEEDLE,1","PIDGEY,1","PIDGEOTTO,2","PIDGEOT,3","RATTATA,1","RATICATE,2","SPEAROW,1","FEAROW,2","PIKACHU,2","RAICHU,3","VULPIX,1","NINETALES,1","ZUBAT,1","GOLBAT,2","VENOMOTH,1","DIGLETT,1","DUGTRIO,2","MEOWTH,1","PERSIAN,2","POLIWAG,1","POLIWHIRL,2","PONYTA,1","RAPIDASH,2","VOLTORB,1","ELECTRODE,2","STARYU,1","STARMIE,2","ELECTABUZZ,2","TAUROS,1","MAGIKARP,1","JOLTEON,2","AERODACTYL,2","CYNDAQUIL,1","QUILAVA,1","FURRET,2","CROBAT,3","PICHU,1","XATU,1","SKIPLOOM,2","JUMPLUFF,3","AIPOM,1","YANMA,1","MURKROW,1","SNEASEL,1","DELIBIRD,1","SMEARGLE,1","ELEKID,1","MAGBY,1","RAIKOU,2","TREECKO,1","GROVYLE,2","SCEPTILE,3","ZIGZAGOON,1","LINOONE,2","TAILOW,1","SWELLOW,2","WINGULL,1","SURSKIT,1","VIGOROTH,2","NINJASK,2","SKITTY,1","DELCATTY,1","MEDITITE,1","MEDICHAM,2","ELECTRIKE,1","MANECTRIC,2","PLUSLE,1","MINUN,1","VOLBEAT,1","ILLUMISE,1","VIBRAVA,1","FLYGON,2","FEEBAS,1","LUVDISC,1","DEOXYS,1","CHIMCHAR,1","MONFERNO,1","INFERNAPE,1","STARLY,1","STARAVIA,2","COMBEE,1","PACHIRISU,1","BUIZEL,1","FLOATZEL,2","AMBIPOM,2","BUNEARY,1","LOPUNNY,2","GLAMEOW,1","PURUGLY,2","STUNKY,1","FINNEON,1","LUMINEON,2","WEAVILE,1","FROSLASS,2","ROTOM,1","DARKRAI,1"};
	...
	public boolean throwPokeball(PokeBall p) {
		...
		case FASTBALL:
			...
			pokeID == 209 || pokeID == 114 || pokeID == 201	||
			pokeID == 243 || pokeID == 244 || pokeID == 245 ||	// Roaming pokemon
			pokeID == 380 || pokeID == 381 || pokeID == 144 ||
			pokeID == 145 || pokeID == 146 || pokeID == 481 ||
			pokeID == 488 ||
