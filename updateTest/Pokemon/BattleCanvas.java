...
public class BattleCanvas extends Container {
	...
	public void drawOurPoke(){
		...
		playerPoke.setSize(160, 160);
		playerPoke.setLocation(10, 280);
		add(playerPoke);
	}
	...
	public void startPokeballs(){
		...
		for (int i = 0; i < 6; i++){
			...
			m_enemyPokeballs.get(i).setLocation(475 + 14 * x + x * 5, 3);
			x++;
		}
	}
	...
	public void drawEnemyPoke(){
		...
		try{
			...
			enemyPoke.setSize(160, 160);
			enemyPoke.setLocation(620, 30);
			add(enemyPoke);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void drawOurInfo(){
        ...
        playerStatus.setLocation(playerNameLabel.getX(), 270);
	...
	public void drawEnemyInfo(){
        ...
        enemyStatus.setLocation(735, 40);
	 ...
	 */
		...
		if(respath == null || respath.equals("null"))
			respath="";
		try {
			bgPic = new Label(new Image(respath+"res/ui/image"+num+".png", false));
		} catch (SlickException e) {
			e.printStackTrace();
		} try {
		...
		add(playerDataBG);
		add(enemyDataBG);
		bgPic.setBounds(0, 0, 800, 406);
		playerDataBG.setBounds(10, 240, 170, 48);
		enemyDataBG.setBounds(615, 10, 170, 48);
		}
	/**
	...
	public void initPlayerHPBar(){
        ...
        updatePlayerHP(BattleManager.getInstance().getCurPoke().getCurHP());
                        ...
                        playerHPBar.setLocation(playerNameLabel.getX(), 270);
